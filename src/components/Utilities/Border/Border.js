        ...
        <Card>
          <Card.Body>
            ...
            <div className="d-flex flex-wrap">
              <div className="p-5 w-40 mg-l-10 mb-2 bg-gray-100 bd bd-2">
                .bd
              </div>
              <div className="p-5 w-40 mg-l-10 mb-2 bg-gray-100 bd-s bd-2  ">
                .bd-s
              </div>
              <div className="p-5 w-40 mg-l-10 mb-2 bg-gray-100 bd-t bd-2 ">
                .bd-t
              </div>
              <div className="p-5 w-40 mg-l-10 mb-2 bg-gray-100 bd-y bd-2 ">
                .bd-y
              </div>
              <div className="p-5 w-40 mg-l-10 mb-2 bg-gray-100 bd-e bd-2">
                .bd-e
              </div>
              <div className="p-5 w-40 mg-l-10 mb-2 bg-gray-100 bd-x bd-2  ">
                .bd-x
              </div>
              <div className="p-5 w-40 mg-l-10 mb-2 bg-gray-100 bd-e bd-b bd-2 mb-0">
                .bd-b
              </div>
            </div>
            <div className="table-responsive mg-t-25">
              <Table className="table main-table-reference mg-b-0 mg-t-10">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code className="p-0 bg-transparent">className="bd"</code>
                    </td>
                    <td>
        ...
        <Card>
          <Card.Body>
            ...
            <div className="d-flex flex-wrap">
              ...
              <div className="p-5 w-40 mg-l-10 mb-2 bg-gray-100 bd bd-3">
                .bd .bd-3
              </div>
              <div className="p-5 w-40 mg-l-10 mb-2 bg-gray-100 bd bd-4">
                .bd .bd-4
              </div>
              <div className="p-5 w-40 mg-l-10 mb-2 bg-gray-100 bd bd-5">
                .bd .bd-5
              </div>
            </div>
            <div className="table-responsive mg-t-25">
      ...
      <Col md={12} xl={12} xs={12} sm={12}>
        <div className="card mg-b-20">
          <Card.Body>
            ...
            <div className="d-flex flex-wrap">
              <div className="p-5 w-40 mg-l-10 mb-2 bg-gray-100 bd bd-2 bd-t-0">
                .border
              </div>
              <div className="p-5 w-40 mg-l-10 mb-2 bg-gray-100 bd bd-2 bd-e-0">
                .border
              </div>
              <div className="p-5 w-40 mg-l-10 mb-2 bg-gray-100 bd bd-2 bd-b-0">
                .border
              </div>
              <div className="p-5 w-40 mg-l-10 mb-2 bg-gray-100 bd bd-2 bd-s-0">
                .border
              </div>
              <div className="p-5 w-40 mg-l-10 mb-2 bg-gray-100  bd bd-2 bd-x-0">
                .border
              </div>
              <div className="p-5 w-40 mg-l-10 mb-2 bg-gray-100 bd bd-2 bd-y-0">
                .border
              </div>
            </div>
            <div className="table-responsive mg-t-25">
              <Table className="table main-table-reference text-nowrap mg-b-0 mg-t-10">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code className="p-0 bg-transparent">.bd-t-0</code>
                    </td>
                    <td>Remove top border of an element</td>
                  </tr>
                  <tr>
                    <td>
                      <code className="p-0 bg-transparent">.bd-e-0</code>
                    </td>
                    <td>Remove right border of an element</td>
                  </tr>
                  <tr>
                    <td>
                      <code className="p-0 bg-transparent">.bd-b-0</code>
                    </td>
                    <td>Remove bottom border of an element</td>
                  </tr>
                  <tr>
                    <td>
                      <code className="p-0 bg-transparent">.bd-s-0</code>
                    </td>
                    <td>Remove left border of an element</td>
                  </tr>
                  <tr>
                    <td>
                      <code className="p-0 bg-transparent">.bd-x-0</code>
                    </td>
                    <td>Remove left and right border of an element</td>
                  </tr>
                  <tr>
                    <td>
                      <code className="p-0 bg-transparent">.bd-y-0</code>
                    </td>
      ...
      <Col md={12} xl={12} xs={12} sm={12}>
        <Card>
          <Card.Body>
            ...
            <div className="d-flex flex-wrap">
              <div className="p-5 w-40 mg-l-10 mb-2 bd bd-2 bd-primary">
                .border
              </div>
              <div className="p-5 w-40 mg-l-10 mb-2 bd bd-2 bd-success">
                .border
              </div>
              <div className="p-5 w-40 mg-l-10 mb-2 bd bd-2 bd-danger">
                .border
              </div>
              <div className="p-5 w-40 mg-l-10 mb-2 bd bd-2 bd-warning">
                .border
              </div>
              <div className="p-5 w-40 mg-l-10 mb-2 bd bd-2 bd-secondary">
                .border
              </div>
              <div className="p-5 w-40 mg-l-10 mb-2 bd bd-2 bd-teal">
                .border
              </div>
            </div>
              ...
              <Table className="table main-table-reference text-nowrap mg-b-0 mg-t-0">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <code className="p-0 bg-transparent">.bd-[value]</code>
                    </td>
                    <td>
                      <code className="p-0 bg-transparent">
                        .bd-gray-[value]
              ...
              <Table className="table main-table-reference mg-b-0 mg-t-0">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <code className="p-0 bg-transparent">.radius</code>
                    </td>
                    <td>
                      <code className="p-0 bg-transparent">
                        .radius-[value]
