        ...
        <div>
            ...
            <div className="breadcrumb-header justify-content-between">
                <div className="left-content">
                    <span className="main-content-title mg-b-0 mg-b-lg-1">Call Management</span>
                </div>
                                ...
                                <Table className="table table-bordered table-hover mb-0 text-md-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>UserId</th>
                                            <th>UserPhoneNo</th>
                                            <th>No.Of Voice Calls</th>
                                            <th>No. Of Video Calls</th>
                                    ...
                                    <tbody>
                                        {data.map((list, index) => (
                                            <tr key={index}>
                                                ...
                                                <td>{list.No.OfVoiceCalls}</td>
                                                <td>{list.No.OfVideoCalls}</td>
